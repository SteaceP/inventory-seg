...
const translations: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    'lang.en': 'الإنجليزية',
    'lang.ar': 'عربي',
    'settings.avatarUploadError': 'فشل تحميل الصورة الرمزية. الرجاء معاودة المحاولة لاحقًا',
  ...
  fr: {
    ...
    'settings.saveError': "L'enregistrement des paramètres a échoué. Veuillez réessayer.",
    ...
    'errors.uploadImage': "Erreur lors du téléchargement de l'image. Veuillez réessayer.",
    'errors.updateStock': "Erreur lors de la mise à jour du stock.",
    'errors.updateItem': "La mise à jour de l'article a échoué. Veuillez réessayer.",
    ...
    'errors.deleteItem': "La suppression de l'article a échoué. Veuillez réessayer.",
    ...
    'inventory.searchPlaceholder': 'Rechercher des articles par nom, SKU ou catégorie...',
    ...
    'appliances.deleteConfirm': "Êtes-vous sûr de vouloir supprimer cet appareil ?",
    ...
    'dashboard.description.withName': "Voici un aperçu de votre inventaire aujourd'hui.",
    'dashboard.description.default': 'Gestion globale de votre stock et statistiques.',
  ...
  en: {
    ...
    'dashboard.description.withName': "Here's an overview of your inventory today.",
...
export function useTranslation() {
  ...
  const t = useCallback((key: string) => translations[language || 'fr'][key] || key, [language]);
