const fr = {
  ...
  "inventory.usingBaseThreshold": "Utilise le seuil par défaut",
  ...
  "inventory.editCategoryThreshold": "Modifier le seuil",
  ...
  "inventory.stats.totalItems": "Total des Articles",
  ...
  "inventory.stockLocations": "Emplacements de stock",
  ...
  "appliances.status.functional": "Fonctionnel",
  ...
  "appliances.warranty.expiringSoon": "Expire dans {{days}} j",
  ...
  "appliances.warrantyExpiry": "Expiration de garantie",
  ...
  "inventory.locations.error.delete":
    "La suppression de l'emplacement a échoué.",
